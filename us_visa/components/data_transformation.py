    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                target_feature_train_df = target_feature_train_df.astype(str).str.strip().str.lower()
                ...
                target_feature_test_df = target_feature_test_df.astype(str).str.strip().str.lower()
